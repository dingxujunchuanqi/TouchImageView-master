...
/**
 * Created by dingxujun on 2018/5/10.
 *
 * @project TouchImageView-master
 */

public class DragFloatActionButton implements View.OnTouchListener{
    ...
    private DragFloatActionButton(DragFloatActionButton.Builder builder, View view) {
    ...
    private void initDragView() {
        ...
        int left = mBuilder.needNearEdge ? ScreenUtil.getInstance(mActivity).getScreenWidth() - 120 : mBuilder.defaultLeft;
    ...
    public static DragFloatActionButton addDragView(DragFloatActionButton.Builder builder, View view) {
        DragFloatActionButton sonnyJackDragView = new DragFloatActionButton(builder, view);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                System.out.println("-----v.layout------down-------");
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                System.out.println("-----v.layout-----move--------");
                v.layout(left, top, right, bottom);
                mLastX = (int) event.getRawX();
                mLastY = (int) event.getRawY();
                break;
            case MotionEvent.ACTION_UP:
                System.out.println("-----v.layout------up-------");
    ...
    private void moveNearEdge() {
        ...
        valueAnimator.addUpdateListener(animation -> {
            ...
            mDragView.setLayoutParams(createLayoutParams(left1, mDragView.getTop(), 0, 0));
        });
        valueAnimator.start();
    }
